Shader "Custom/Ocean"
{
    Properties
    {
		...
		_DepthGradientShallow("Depth Gradient Shallow", Color) = (0.3254902, 0.9100327,0.972549, 1)

		// What color the water will sample when the surface below is at its deepest.
		_DepthGradientDeep("Depth Gradient Deep", Color) = (0.086, 0.6812238, 1, 1)

		// Maximum distance the surface below the water will affect the color gradient.
		_DepthMaxDistance("Depth Maximum Distance", Float) = 2.76//1
		...
		_SurfaceNoiseCutoff("Surface Noise Cutoff", Range(0, 1)) = 0.76
		...
		_SurfaceDistortionAmount("Surface Distortion Amount", Range(0, 1)) = 0.242

		// Control the distance that surfaces below the water will contribute
		// to foam being rendered.
		_FoamMaxDistance("Foam Maximum Distance", Float) = 2.15//0.4
		_FoamMinDistance("Foam Minimum Distance", Float) = 0.76//0.04		
    }
    SubShader
    {
    	LOD 300
